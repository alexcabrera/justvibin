...
func TestRootCommandHelp(t *testing.T) {
	...
	if !strings.Contains(output, "justvibin") {
		t.Fatalf("expected help output to mention justvibin")
	}
}
...
func TestRootCommandMutuallyExclusiveFlags(t *testing.T) {
	...
	rootCmd.SetOut(stdout)
	rootCmd.SetErr(stderr)
	rootCmd.SetArgs([]string{"--quiet", "--verbose", "templates"})
...
func TestNewHelpShowsExamples(t *testing.T) {
	...
	if !strings.Contains(output, "justvibin new") {
