...
var proxyCmd = &cobra.Command{
	...
	Example: "justvibin proxy start\njustvibin proxy status\njustvibin proxy status --json\njustvibin proxy logs --lines 200",
}
...
var proxyRestartCmd = &cobra.Command{
	...
	Example: "justvibin proxy restart",
...
var proxyStatusCmd = &cobra.Command{
	...
	Example: "justvibin proxy status\njustvibin proxy status --json",
...
var proxyLogsCmd = &cobra.Command{
	...
	Example: "justvibin proxy logs\njustvibin proxy logs --lines 200\njustvibin proxy logs --follow=false",
