...
---
# Implement 'justvibin update' command
...
```
justvibin update <name>   # Update specific template
justvibin update --all    # Update all templates
```
...
update_template() {
    ...
    if [[ -z "$source_url" ]]; then
        ...
        log_info "Re-install with: justvibin install <url> --name $name"
        exit 1
    fi
