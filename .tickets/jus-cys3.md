...
---
# Define justvibin.toml manifest schema

Define and document the justvibin.toml manifest schema that templates must include.
...
[project]
# Fields to include in .justvibin project file
...
- [ ] Schema documented in justvibin README
