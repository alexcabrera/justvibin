...
justvibin is a CLI for scaffolding web projects. A key goal of the Cobra/Fang migration is enabling headless operation in CI/CD pipelines. This ticket adds CI-specific tests.
...
1. Create cmd/justvibin/headless_test.go:
...
headless-test:
  ...
  steps:
    ...
    - name: Run headless tests
      run: |
        # Ensure no TTY
        go test -v -run 'Headless' ./cmd/justvibin/
```
