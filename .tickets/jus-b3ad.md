...
cmd_start() {
    ...
    if ! is_justvibin_project; then
        ...
        log_info "Create a project: justvibin new <name>"
        log_info "Or register this directory: justvibin register"
        exit 1
    fi
    ...
    if is_project_running; then
        ...
        log_info "Stop with: justvibin stop"
        return 0
    fi
...
- [ ] Detects project from .justvibin
