...
justvibin is a CLI for scaffolding web projects. Fang adds a hidden 'man' command that generates manpages using mango for better roff output.

## Current State

Fang automatically adds:
- justvibin man (hidden command)
...
```bash
# Generate manpage
justvibin man > justvibin.1

# Install (macOS)
sudo cp justvibin.1 /usr/local/share/man/man1/
...
- [ ] justvibin man generates valid roff output
