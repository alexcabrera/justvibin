...
cmd_help() {
    ...
    if has_gum; then
        ...
        echo "  sync            Rebuild registry from .justvibin files"
        echo "  proxy <cmd>     Manage proxy (start|stop|status)"
        echo "  help            Show this help"
        echo ""
    else
        # Fallback without gum
        echo "justvibin - scaffold and serve web projects"
        echo ""
        echo "Usage: justvibin <command> [args]"
        echo ""
        echo "Commands:"
...
main() {
    ...
    case "$cmd" in
        ...
        --version|-v) echo "justvibin v$JUSTVIBIN_VERSION" ;;
        *)
