...
justvibin is a CLI for scaffolding web projects. To support headless/scripted usage, we need global flags that control output behavior consistently across all commands.

## Current State

File: cmd/justvibin/root.go (created in earlier ticket)
...
1. Update cmd/justvibin/root.go to add persistent flags:
...
- [ ] justvibin --help shows global flags
- [ ] justvibin new --help shows global flags inherited
- [ ] justvibin -q new myproject suppresses progress messages
- [ ] justvibin --verbose new myproject shows extra detail
- [ ] justvibin --no-color new myproject has no ANSI codes
- [ ] justvibin --json templates outputs JSON
